(() => {
    ...
    function initSliders() {
        if (document.querySelector(".carousel")) new Swiper(".carousel__slider", {
        ...
        if (document.querySelector(".location__slider")) new Swiper(".location__slider", {
            modules: [ Navigation, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const reasonItems = document.querySelectorAll(".reasons__item");
        const reasonImages = document.querySelectorAll(".reasons__img");
        reasonItems.forEach((item => {
            item.addEventListener("click", (() => {
                reasonItems.forEach((el => el.classList.remove("active-reason")));
                item.classList.add("active-reason");
                const reasonId = item.getAttribute("data-reason");
                reasonImages.forEach((img => img.classList.remove("active-reason")));
                document.getElementById(reasonId).classList.add("active-reason");
            }));
        }));
    }));
    window["FLS"] = true;
